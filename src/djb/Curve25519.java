...
public class Curve25519 {
	...
	/* Key-pair generation
	 *   P  [out] your public key, 32 bytes
	 *   s  [out] your private key for signing
	 *   k  [out] your private key for key agreement, 32 bytes
	 *   k  [in]  32 random bytes, 32 bytes
	...
	private static void cpy32(byte[] d, final byte[] s) {
		int i;
		for (i = 0; i < 32; i++)
			d[i] = s[i];
	}
	...
	private static void unpack(long10 x, final byte[] m) {
	...
	/* P = kG   and  s = sign(P)/k  */
	private static void core(byte[] Px, byte[] s, final byte[] k, final byte[] Gx) {
		long10 
		    dx=new long10(),
		    t1=new long10(),
		    t2=new long10(),
