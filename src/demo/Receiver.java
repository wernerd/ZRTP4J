...
public class Receiver
	...
	if (evt instanceof RemotePayloadChangeEvent) {
	    ...
	    System.err.println("RemotePayloadChangeEvent received. Can't handle this event. "
			       + evt);
	}
	...
	// System.err.println("Received a transferData request from: " + stream.toString());
	...
	System.err.println("buf length: "+ buf.getLength() + ", timestamp: "+ buf.getTimeStamp());
	// System.err.println("buffer: " + buf.getFormat().toString());

	if (cls == Format.byteArray) {
	    byte[] data = (byte[])buf.getData();
	    System.err.println("Data: '" + new String(data, buf.getOffset(), buf.getLength()) + "'");
	}
    }
