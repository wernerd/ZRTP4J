...
public class TransmitterMultiPBXEnroll {
...
//                config.setMandatoryOnly();
                ...
                if (multiStream) {
                    ...
                    // This now behaves like a PBX enrollment service
                    zrtpEngine.setEnrollmentMode(true);
    ...
    public static void main(String[] args) {
        ...
        TransmitterMultiPBXEnroll trans = new TransmitterMultiPBXEnroll();
        trans.doIt();
        try {
            Thread.sleep(2000);
        } catch (InterruptedException ie) {
